 ...
 * for end users.
 */
/* default */ final class CliInfoPrinter {
    ...
    private final String _versionMessage;
    private final String _usageMessageHeader;
    private final String _usageMessageFooter;
